  ...
  useEffect(() => {
    ...
    const revealTargets = Array.from(
      document.querySelectorAll<HTMLElement>(
        ".hero-banner, .section-block, .glass-panel, .photo-tile, .story-gallery-card, .story-hero, .story-chapter, .story-sisters-sport, .story-paradox-card, .story-manifesto, .cover-card, .fan-moment-card, .video-picker-card",
      ),
    );
